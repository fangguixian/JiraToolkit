    ...
    return {
        ...
        statistical_workload__data_show: function (data) {
            ...
            $.each(data, function (user_key, user_data) {
                ...
                var link_develop_main = 'http://jira.51zxtx.com/issues/?filter=12618&jql=issuetype%20IN%20standardIssueTypes()%20AND%20(%0A%20%20%20%20(%20status%20IN(%E5%BE%85%E5%BC%80%E5%8F%91%2C%E5%BC%80%E5%8F%91%E4%B8%AD)%20AND%20%E5%BC%80%E5%8F%91%E8%B4%9F%E8%B4%A3%E4%BA%BA%3D' + user_key + '%20AND%20%E5%BC%80%E5%8F%91%E9%A2%84%E4%BC%B0%E6%B6%88%E8%80%97%20IS%20NOT%20EMPTY%20)%20AND%20%0A%20%20%20%20fixVersion%20IS%20NOT%20EMPTY%0A)%20ORDER%20BY%20status%20DESC';
                var link_develop_common = 'http://jira.51zxtx.com/issues/?filter=12618&jql=issuetype%20IN%20standardIssueTypes()%20AND%20(%0A%20%20%20%20(%20status%20IN(%E5%BE%85%E5%BC%80%E5%8F%91%2C%E5%BC%80%E5%8F%91%E4%B8%AD)%20AND%20%E5%BC%80%E5%8F%91%E8%B4%9F%E8%B4%A3%E4%BA%BA%3D' + user_key + '%20AND%20%E5%BC%80%E5%8F%91%E9%A2%84%E4%BC%B0%E6%B6%88%E8%80%97%20IS%20NOT%20EMPTY%20)%20AND%20%0A%20%20%20%20fixVersion%20IS%20EMPTY%0A)%20ORDER%20BY%20status%20DESC';
                var link_test = 'http://jira.51zxtx.com/issues/?filter=12619&jql=issuetype%20IN%20standardIssueTypes()%20AND%20(%0A%20%20%20%20(%20status%20IN(%E5%BE%85%E5%BC%80%E5%8F%91%2C%E5%BC%80%E5%8F%91%E4%B8%AD%2C%E5%BE%85%E6%B5%8B%E8%AF%95%2C%E6%B5%8B%E8%AF%95%E4%B8%AD)%20AND%20%E6%B5%8B%E8%AF%95%E8%B4%9F%E8%B4%A3%E4%BA%BA%3D' + user_key + '%20AND%20%E6%B5%8B%E8%AF%95%E9%A2%84%E4%BC%B0%E6%B6%88%E8%80%97%20IS%20NOT%20EMPTY%20)%0A)%20ORDER%20BY%20status%20DESC';
                var link_test_main = 'http://jira.51zxtx.com/issues/?filter=12619&jql=issuetype%20IN%20standardIssueTypes()%20AND%20(%0A%20%20%20%20(%20status%20IN(%E5%BE%85%E5%BC%80%E5%8F%91%2C%E5%BC%80%E5%8F%91%E4%B8%AD%2C%E5%BE%85%E6%B5%8B%E8%AF%95%2C%E6%B5%8B%E8%AF%95%E4%B8%AD)%20AND%20%E6%B5%8B%E8%AF%95%E8%B4%9F%E8%B4%A3%E4%BA%BA%3D' + user_key + '%20AND%20%E6%B5%8B%E8%AF%95%E9%A2%84%E4%BC%B0%E6%B6%88%E8%80%97%20IS%20NOT%20EMPTY%20)%20AND%20%0A%20%20%20%20fixVersion%20IS%20NOT%20EMPTY%0A)%20ORDER%20BY%20status%20DESC';
                var link_test_common = 'http://jira.51zxtx.com/issues/?filter=12619&jql=issuetype%20IN%20standardIssueTypes()%20AND%20(%0A%20%20%20%20(%20status%20IN(%E5%BE%85%E5%BC%80%E5%8F%91%2C%E5%BC%80%E5%8F%91%E4%B8%AD%2C%E5%BE%85%E6%B5%8B%E8%AF%95%2C%E6%B5%8B%E8%AF%95%E4%B8%AD)%20AND%20%E6%B5%8B%E8%AF%95%E8%B4%9F%E8%B4%A3%E4%BA%BA%3D' + user_key + '%20AND%20%E6%B5%8B%E8%AF%95%E9%A2%84%E4%BC%B0%E6%B6%88%E8%80%97%20IS%20NOT%20EMPTY%20)%20AND%20%0A%20%20%20%20fixVersion%20IS%20EMPTY%0A)%20ORDER%20BY%20status%20DESC';
        ...
        statistical_overdue: function () {
            ...
            CONTENT_SCRIPT.jira_search(
                {
                    jql: "issuetype in standardIssueTypes() AND status in (确认中, 设计中, 排期中, 待开发, 开发中, 测试未通过, 待测试, 测试中, 验收未通过, 待验收, 验收中, 待发布, 发布中)",
        ...
        statistical_overdue__data_process: function (issues) {
            ...
            $.each(issues, function (idx, issue) {
                ...
                // 内部测试（单一组负责）
                if ($.inArray(issue.fields.status.name, ['待开发', '开发中', '测试未通过', '待测试', '测试中', '验收未通过']) !== -1) {
                    user = issue.fields.customfield_10331; // 测试负责人
                ...
                // 用户验收（单一组负责，工作量少可忽略）
                if ($.inArray(issue.fields.status.name, ['待开发', '开发中', '测试未通过', '待测试', '测试中', '验收未通过', '待验收', '验收中']) !== -1) {
                ...
                // 版本发布（单一组负责，工作量少可忽略）
                if ($.inArray(issue.fields.status.name, ['待开发', '开发中', '测试未通过', '待测试', '测试中', '验收未通过', '待验收', '验收中', '待发布', '发布中']) !== -1) {
